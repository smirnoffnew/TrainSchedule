            ...
            <>
              <div className="rowItem" style={{ width: '10%' }}>
                {stationsTypes === 'BUS_STATION' ?
                  theme === 'light' ?
                    <div className="buss-icon" style={{ alignSelf: 'center' }}>
                  ...
                  : <img src={trainIcon} alt="TrainLogo" className="train-icon" style={{ alignSelf: 'center' }}/>
                }

                <div className="row-item-text" style={{ paddingLeft: 7 }}>{connectNumber}</div>
              </div>
